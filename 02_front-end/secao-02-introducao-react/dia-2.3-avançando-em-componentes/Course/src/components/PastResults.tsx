...
// É comum utilizar o map, pois ele gera um retorno JSX, que será renderizado na tela, enquanto o forEach retorna undefined

// É importante ressaltar que é necessário adicionar essa lógica dentro de chaves {}, pois se trata de código JavaScript
